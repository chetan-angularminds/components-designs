  ...
  return (
    <section className="py-20 bg-gradient-to-r from-emerald-600 via-teal-600 to-slate-700 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 border-white text-white hover:bg-white hover:text-emerald-600 bg-transparent group"
              >
        ...
        />
        <motion.div
          className="absolute bottom-10 right-10 w-16 h-16 bg-emerald-300/20 rounded-full"
          animate={{ y: [0, 20, 0] }}
